...
public class HueBridge {
	...
	final Map<Integer, HueLightGroup> groups = new TreeMap<Integer, HueLightGroup>();
	final Map<Integer, HueVirtualLightGroup> virtualGroups = new TreeMap<Integer, HueVirtualLightGroup>();
	...
	public Collection<? extends HueLightBulb> getNewLights() {
		...
		final ArrayList<HueLightBulb> result = new ArrayList<HueLightBulb>();
